...
** GitHub Repository:** [VishwaPatel892/food-order-system](https://github.com/VishwaPatel892/food-order-system)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VishwaPatel892/food-order-system.git
   cd food-order
   ```
...
**Vishwa Patel**  
[VishwaPatel892](https://github.com/VishwaPatel892)
